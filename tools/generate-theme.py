...
/* Ilustrasi halaman login dipakai ulang sebagai watermark di bagian bawah
   sidebar. Opacity .14 -> area paling terang ilustrasi tetap menyisakan
   kontras 7.3:1 untuk label putih (AA butuh 4.5). Ditempatkan di bawah
   dengan mask memudar supaya menu di atas berada pada warna solid. */
.sidebar::before,
